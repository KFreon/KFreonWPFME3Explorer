...
namespace KFreonLibME.PCCObjects
{
    ...
    public static class SaltPropertyReader
    {
        ...
        public static List<Property> getPropList(AbstractPCCObject pcc, byte[] raw)
        {
        ...
        public static string PropertyToText(Property p, AbstractPCCObject pcc)
        {
            string s = "";
            s = "Name: " + p.Name;
        ...
        public static CustomProperty PropertyToGrid(Property p, AbstractPCCObject pcc)
        {
            ...
            switch (p.TypeVal)
            {
                ...
                case Type.ObjectProperty:
                    ...
                    ppo.name = pcc.GetClass(p.Value.IntValue);
        ...
        public static List<Property> ReadProp(AbstractPCCObject pcc, byte[] raw, int start)
        {
            Property p;
            PropertyValue v;
            int sname;
        ...
        private static Type getType(AbstractPCCObject pcc, int type)
        {
        ...
        private static PropertyValue ReadValue(AbstractPCCObject pcc, byte[] raw, int start, int type)
        {
        ...
        public static int detectStart(AbstractPCCObject pcc, byte[] raw)
        {
            int result = 8;
    ...
    public static class PropertyReader
    {
        ...
        public static int detectStart(AbstractPCCObject pcc, byte[] raw, long flags)
        {
