...
namespace KFreonLibME.MEDirectories
{
    ...
    public class MEDirectories : ViewModelBase
    {
        ...
        public static string SelectGameLoc(int GameVers)
        {
            ...
            using (OpenFileDialog selectDir = new OpenFileDialog())
            {
        ...
        public string ExecFolder
        {
            ...
            {
                if (execf == null)
                    execf = Path.Combine(Application.ExecutablePath.GetDirParent(), "Exec\\");
        ...
        // KFreon: Gets path to games thumbnail cache on disk
        public string ThumbnailCache
        {
            get
            {
                return GetDifferentThumbnailCache(GameVersion);
            }
        }
        #endregion Misc
        #endregion
        ...
        public MEDirectories(bool ask = false)
        {
        ...
        /// <summary>
        /// Gets ThumbnailCache for specified game
        /// </summary>
        /// <param name="game">Game to get cache for. Valid: 1-3</param>
        /// <returns>ThumbnailCache of specified game.</returns>
        public string GetDifferentThumbnailCache(int game)
        {
            if (game == 0)
                return null;

            return Path.Combine(ExecFolder, "ThumbnailCaches", "ME" + game + "ThumbnailCache");
        }
        ...
        /// <param name="Autosave">Saves Properties.</param>
        public static void SetBIOGame(int game, string path, bool Autosave = true)
        {
            ...
            try
            {
                ...
                {
                    case 1:
                        Properties.Settings.Default.ME1BIOGame = path;
                        break;
                    case 2:
                        Properties.Settings.Default.ME2BIOGame = path;
                        break;
                    case 3:
                        Properties.Settings.Default.ME3BIOGame = path;
                        break;
                }
        ...
        public static void SetCooked(int game, string path, bool Autosave = true)
        {
            ...
            try
            {
                ...
                {
                    case 1:
                        Properties.Settings.Default.ME1CookedPath = path;
                        break;
                    case 2:
                        Properties.Settings.Default.ME2CookedPath = path;
                        break;
                    case 3:
                        Properties.Settings.Default.ME3CookedPath = path;
                        break;
                }
        ...
        public static void SetDLCPath(int game, string path, bool Autosave = true)
        {
            ...
            try
            {
                ...
                {
                    case 1:
                        Properties.Settings.Default.ME1DLCPath = path;
                        break;
                    case 2:
                        Properties.Settings.Default.ME2DLCPath = path;
                        break;
                    case 3:
                        Properties.Settings.Default.ME3DLCPath = path;
                        break;
                }
        ...
        public static void SetExePath(int game, string path, bool Autosave = true)
        {
            ...
            try
            {
                ...
                {
                    case 1:
                        Properties.Settings.Default.ME1ExePath = path;
                        break;
                    case 2:
                        Properties.Settings.Default.ME2ExePath = path;
                        break;
                    case 3:
                        Properties.Settings.Default.ME3ExePath = path;
                        break;
                }
        ...
        /// <summary>
        /// Gets BIOGamePath from previously saved Properties.
        /// </summary>
        ...
        public static string GetBIOGameProperty(int game)
        {
            ...
            {
                case 1:
                    retval = Properties.Settings.Default.ME1BIOGame;
                    break;
                case 2:
                    retval = Properties.Settings.Default.ME2BIOGame;
                    break;
                case 3:
                    retval = Properties.Settings.Default.ME3BIOGame;
                    break;
            }
            return retval;
        }
        ...
        /// <summary>
        /// Gets DLCPath from previously saved Properties.
        /// </summary>
        /// <param name="game">Game to get property for</param>
        public static string GetDLCPathProperty(int game)
        {
            ...
            {
                case 1:
                    retval = Properties.Settings.Default.ME1DLCPath;
                    break;
                case 2:
                    retval = Properties.Settings.Default.ME2DLCPath;
                    break;
                case 3:
                    retval = Properties.Settings.Default.ME3DLCPath;
                    break;
            }
            return retval;
        }
        ...
        /// <summary>
        /// Gets ExePath from previously saved Properties.
        /// </summary>
        /// <param name="game">Game to get property for</param>
        public static string GetExePathProperty(int game)
        {
            ...
            {
                case 1:
                    retval = Properties.Settings.Default.ME1ExePath;
                    break;
                case 2:
                    retval = Properties.Settings.Default.ME2ExePath;
                    break;
                case 3:
                    retval = Properties.Settings.Default.ME3ExePath;
                    break;
            }
            return retval;
        }
        ...
        /// <summary>
        /// Gets CookedPath from previously saved Properties.
        /// </summary>
        /// <param name="game">Game to get property for</param>
        public static string GetCookedProperty(int game)
        {
            ...
            {
                case 1:
                    retval = Properties.Settings.Default.ME1CookedPath;
                    break;
                case 2:
                    retval = Properties.Settings.Default.ME2CookedPath;
                    break;
                case 3:
                    retval = Properties.Settings.Default.ME3CookedPath;
                    break;
            }
            return retval;
        }
