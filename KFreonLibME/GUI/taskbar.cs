...
namespace KFreonLibME.GUI
{
    /// <summary>
    /// WarrantyVoider's Taskbar implementation. 
    /// It's here because all relevant projects can reference this project rather than duplicating code.
    /// </summary>
